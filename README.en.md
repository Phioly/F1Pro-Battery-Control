...
**Current version**: `v0.6.12` · **Requires**: SteamOS + Decky Loader · **Does not touch** TDP / CPU scheduling (coexists with SimpleDeckyTDP)
...
1. Copy `F1ProECControl-v0.6.12.zip` to the handheld.
